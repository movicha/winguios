...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"wingufile" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"wingufile.sqlite"];
...
- (void)initTabController
{
    ...
    UINavigationController *masterNavigationController = [self.tabbarController.viewControllers objectAtIndex:TABBED_WINGUFILE];
...
{
    return [self.tabbarController.viewControllers objectAtIndex:TABBED_WINGUFILE];
}
...
- (SeafDetailViewController *)detailVC
{
    if (_detailVC)
        return _detailVC;
    if (IsIpad())
        _detailVC = (SeafDetailViewController *)[[[self.splitVC.viewControllers lastObject] viewControllers] objectAtIndex:TABBED_WINGUFILE];
    else {
